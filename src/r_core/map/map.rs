...
impl Map {
    pub fn new_map_a() -> Self {
        let shapes = vec![Rect {
            pos: Vec2::new(56.332f32, 613.317f32),
            w_h: CONTAINER_SIDE,
        }, Rect {
            pos: Vec2::new(-70.1838f32, 613.733f32),
            w_h: CONTAINER_SIDE,
        }, Rect {
            pos: Vec2::new(183.332f32, 613.317f32),
            w_h: CONTAINER_SIDE,
        }, Rect {
            pos: Vec2::new(309.902f32, 613.317f32),
            w_h: CONTAINER_SIDE,
        }, Rect {
            pos: Vec2::new(436.902f32, 613.317f32),
            w_h: CONTAINER_SIDE,
        }, Rect {
            pos: Vec2::new(564.547f32, 613.317f32),
            w_h: CONTAINER_SIDE,

        }, Rect {
            pos: Vec2::new(691.547f32, 613.317f32),
            w_h: CONTAINER_SIDE,

        }, Rect {
            pos: Vec2::new(818.117f32, 613.317f32),
            w_h: CONTAINER_SIDE,

        }, Rect {
            pos: Vec2::new(945.117f32, 613.317f32),
            w_h: CONTAINER_SIDE,

        }, Rect {
            pos: Vec2::new(1072.41f32, 613.317f32),
            w_h: CONTAINER_SIDE,

        }, Rect {
            pos: Vec2::new(127.629f32, -14.0987f32),
            w_h: CONTAINER_SIDE,

        }, Rect {
            pos: Vec2::new(1.1134f32, -13.6822f32),
            w_h: CONTAINER_SIDE,

        }, Rect {
            pos: Vec2::new(-123.657f32, -13.6822f32),
            w_h: CONTAINER_SIDE,

        }, Rect {
            pos: Vec2::new(254.629f32, -14.0987f32),
            w_h: CONTAINER_SIDE,

        }, Rect {
            pos: Vec2::new(381.199f32, -14.0987f32),
            w_h: CONTAINER_SIDE,

        }, Rect {
            pos: Vec2::new(508.199f32, -14.0987f32),
            w_h: CONTAINER_SIDE,
        }, Rect {
            pos: Vec2::new(635.844f32, -14.0987f32),
            w_h: CONTAINER_SIDE,
        }, Rect {
            pos: Vec2::new(762.844f32, -14.0987f32),
            w_h: CONTAINER_SIDE,

        }, Rect {
            pos: Vec2::new(889.414f32, -14.0987f32),
            w_h: CONTAINER_SIDE,

        }, Rect {
            pos: Vec2::new(1016.41f32, -14.0987f32),
            w_h: CONTAINER_SIDE,

        }, Rect {
            pos: Vec2::new(1143.71f32, -14.0987f32),
            w_h: CONTAINER_SIDE,

        }, RotRect {
            pos: Vec2::new(1149.52f32, 652.298f32),
            w_h: CONTAINER_SIDE,
            rot: std::f32::consts::FRAC_PI_2,
        }, RotRect {
            pos: Vec2::new(1149.58f32, 525.707f32),
            w_h: CONTAINER_SIDE,
            rot: std::f32::consts::FRAC_PI_2,
        }, RotRect {
            pos: Vec2::new(1149.97f32, 398.634f32),
            w_h: CONTAINER_SIDE,
            rot: std::f32::consts::FRAC_PI_2,
        }, RotRect {
            pos: Vec2::new(1150.03f32, 272.042f32),
            w_h: CONTAINER_SIDE,
            rot: std::f32::consts::FRAC_PI_2,
        }, RotRect {
            pos: Vec2::new(1150.03f32, 145.474f32),
            w_h: CONTAINER_SIDE,
            rot: std::f32::consts::FRAC_PI_2,
        }, RotRect {
            pos: Vec2::new(1150.03f32, 17.8873f32),
            w_h: CONTAINER_SIDE,
            rot: std::f32::consts::FRAC_PI_2,
        }, RotRect {
            pos: Vec2::new(-128.915f32, 652.126f32),
            w_h: CONTAINER_SIDE,
            rot: std::f32::consts::FRAC_PI_2,
        }, RotRect {
            pos: Vec2::new(-128.915f32, 525.054f32),
            w_h: CONTAINER_SIDE,
            rot: std::f32::consts::FRAC_PI_2,
        }, RotRect {
            pos: Vec2::new(-128.915f32, 398.365f32),
            w_h: CONTAINER_SIDE,
            rot: std::f32::consts::FRAC_PI_2,
        }, RotRect {
            pos: Vec2::new(-128.915f32, 271.774f32),
            w_h: CONTAINER_SIDE,
            rot: std::f32::consts::FRAC_PI_2,
        }, RotRect {
            pos: Vec2::new(-128.915f32, 145.205f32),
            w_h: CONTAINER_SIDE,
            rot: std::f32::consts::FRAC_PI_2,
        }, RotRect {
            pos: Vec2::new(-128.915f32, 18.6273f32),
            w_h: CONTAINER_SIDE,
            rot: std::f32::consts::FRAC_PI_2,
        }, RotRect {
            pos: Vec2::new(574.701, 16.4741),
            w_h: CONTAINER_AREA,
            rot: std::f32::consts::FRAC_PI_2,
        }, RotRect {
            pos: Vec2::new(574.701, 142.725),
            w_h: CONTAINER_AREA,
            rot: std::f32::consts::FRAC_PI_2,
        }, Rect {
            pos: Vec2::new(515.085, 356.985),
            w_h: CONTAINER_AREA,
        }, Rect {
            pos: Vec2::new(801.926, 358.89),
            w_h: CONTAINER_AREA,
        }, Rect {
            pos: Vec2::new(-41.4074, 180.834),
            w_h: CONTAINER_AREA,
        }, Rect {
            pos: Vec2::new(79.9876, 180.834),
            w_h: CONTAINER_AREA,
        }, RotRect {
            pos: Vec2::new(883.58, 397.678),
            w_h: CONTAINER_AREA,
            rot: std::f32::consts::FRAC_PI_4,
        }, RotRect {
            pos: Vec2::new(291.896, 216.316),
            w_h: CONTAINER_AREA,
            rot: std::f32::consts::FRAC_PI_4,
        }, RotRect {
            pos: Vec2::new(765.132, 80.4514),
            w_h: CONTAINER_AREA,
            rot: std::f32::consts::FRAC_PI_2,
        }, Rect {
            pos: Vec2::new(206.759, 180.834),
            w_h: CONTAINER_AREA,
        }, Rect {
            pos: Vec2::new(451.085, 420.985),
            w_h: CONTAINER_AREA,
        }, Rect {
            pos: Vec2::new(676.88, 551.856),
            w_h: CONTAINER_AREA,
        }, RotRect {
            pos: Vec2::new(79.9876, 520.558),
            w_h: CONTAINER_AREA,
            rot: std::f32::consts::FRAC_PI_2,
        }, RotRect {
            pos: Vec2::new(79.9876, 396.447),
            w_h: CONTAINER_AREA,
            rot: std::f32::consts::FRAC_PI_2,
        }, Rect {
            pos: Vec2::new(1053.98, 244.834),
            w_h: CONTAINER_AREA,
        }];
        std::fs::write(
            "./maps/MapA.json",
    ...
    pub fn new_map_b() -> Self {
        let shapes = vec![
            RotRect {
                pos: Vec2::new(-123.124, 500.264),
                w_h: CAR_A_B,
                rot: std::f32::consts::FRAC_PI_2,
            }, RotRect {
                pos: Vec2::new(-123.298, 350.581),
                w_h: CAR_A_B,
                rot: std::f32::consts::FRAC_PI_2,
            }, RotRect {
                pos: Vec2::new(-123.139, 574.906),
                w_h: CAR_A_B,
                rot: std::f32::consts::FRAC_PI_2,
            }, RotRect {
                pos: Vec2::new(-122.327, 279.376),
                w_h: CAR_A_B,
                rot: std::f32::consts::FRAC_PI_2,
            }, RotRect {
                pos: Vec2::new(-122.863, 133.498),
                w_h: CAR_A_B,
                rot: std::f32::consts::FRAC_PI_2,
            }, RotRect {
                pos: Vec2::new(-123.037, -16.1845),
                w_h: CAR_A_B,
                rot: std::f32::consts::FRAC_PI_2,
            }, RotRect {
                pos: Vec2::new(-122.878, 207.14),
                w_h: CAR_A_B,
                rot: std::f32::consts::FRAC_PI_2,
            }, Rect {
                pos: Vec2::new(221.216, -37.7832),
                w_h: CAR_A_B,
            }, Rect {
                pos: Vec2::new(72.5438, -36.5491),
                w_h: CAR_A_B,
            }, Rect {
                pos: Vec2::new(-71.9961, -37.3872),
                w_h: CAR_A_B,
            }, Rect {
                pos: Vec2::new(1.47256, -37.4734),
                w_h: CAR_A_B,
            }, Rect {
                pos: Vec2::new(366.017, 606.158),
                w_h: CAR_A_B,
            }, Rect {
                pos: Vec2::new(221.536, 607.221),
                w_h: CAR_A_B,
            }, Rect {
                pos: Vec2::new(295.005, 607.135),
                w_h: CAR_A_B,
            }, RotRect {
                pos: Vec2::new(365.547, -36.5491),
                w_h: CAR_C,
                rot: std::f32::consts::FRAC_PI_2,
            }, RotRect {
                pos: Vec2::new(294.475, -37.4734),
                w_h: CAR_A_B,
                rot: std::f32::consts::PI,
            }, RotRect {
                pos: Vec2::new(541.83, 262.791),
                w_h: CAR_C,
                rot: std::f32::consts::PI,
            }, RotRect {
                pos: Vec2::new(468.759, 263.867),
                w_h: CAR_C,
                rot: std::f32::consts::PI,
            }, RotRect {
                pos: Vec2::new(660.237, -36.5491),
                w_h: CAR_C,
                rot: 0.0,//???????
            }, RotRect {
                pos: Vec2::new(960.297, -37.4752),
                w_h: CAR_C,
                rot: std::f32::consts::PI,
            }, RotRect {
                pos: Vec2::new(1029.76, -37.5139),
                w_h: CAR_C,
                rot: std::f32::consts::PI,
            }, Rect {
                pos: Vec2::new(515.697, -37.3872),
                w_h: CAR_A_B,
            }, Rect {
                pos: Vec2::new(589.166, -37.4734),
                w_h: CAR_A_B,
            }, Rect {
                pos: Vec2::new(887.475, -37.7296),
                w_h: CAR_A_B,
            }, Rect {
                pos: Vec2::new(1101.24, -36.8291),
                w_h: CAR_A_B,
            }, Rect {
                pos: Vec2::new(-74.3384, 605.724),
                w_h: CAR_C,
            }, RotRect {
                pos: Vec2::new(-122.328, 425.732),
                w_h: CAR_C,
                rot: std::f32::consts::FRAC_PI_2,
            }, RotRect {
                pos: Vec2::new(1153.46, 141.973),
                w_h: CAR_A_B,
                rot: std::f32::consts::FRAC_PI_2,
            }, RotRect {
                pos: Vec2::new(1153.44, 216.614),
                w_h: CAR_A_B,
                rot: std::f32::consts::FRAC_PI_2,
            }, RotRect {
                pos: Vec2::new(1152.82, 67.4401),
                w_h: CAR_C,
                rot: std::f32::consts::FRAC_PI_2,
            }, RotRect {
                pos: Vec2::new(1153.16, 508.469),
                w_h: CAR_A_B,
                rot: std::f32::consts::FRAC_PI_2,
            }, RotRect {
                pos: Vec2::new(1152.13, 437.263),
                w_h: CAR_C,
                rot: std::f32::consts::FRAC_PI_2,
            }, RotRect {
                pos: Vec2::new(1152.78, -5.37441),
                w_h: CAR_C,
                rot: std::f32::consts::FRAC_PI_2,
            }, RotRect {
                pos: Vec2::new(1153.59, 291.386),
                w_h: CAR_A_B,
                rot: std::f32::consts::FRAC_PI_2,
            }, RotRect {
                pos: Vec2::new(549.795, 112.382),
                w_h: CAR_A_B,
                rot: std::f32::consts::FRAC_PI_2,
            }, RotRect {
                pos: Vec2::new(587.17, 111.902),
                w_h: CAR_A_B,
                rot: std::f32::consts::FRAC_PI_2,
            }, RotRect {
                pos: Vec2::new(1153.58, 365.027),
                w_h: CAR_A_B,
                rot: std::f32::consts::FRAC_PI_2,
            }, RotRect {
                pos: Vec2::new(1152.13, 583.619),
                w_h: CAR_C,
                rot: std::f32::consts::FRAC_PI_2,
            }, RotRect {
                pos: Vec2::new(-122.067, 57.9661),
                w_h: CAR_C,
                rot: std::f32::consts::FRAC_PI_2,
            }, RotRect {
                pos: Vec2::new(788.54, 550.786),
                w_h: CAR_A_B,
                rot: std::f32::consts::FRAC_PI_2,
            }, RotRect {
                pos: Vec2::new(788.366, 401.103),
                w_h: CAR_A_B,
                rot: std::f32::consts::FRAC_PI_2,
            }, Rect {
                pos: Vec2::new(914.133, 379.253),
                w_h: CAR_C,
            }, RotRect {
                pos: Vec2::new(839.407, 379.9),
                w_h: CAR_A_B,
                rot: 0.0,//?????
            }, RotRect {
                pos: Vec2::new(841.576, 415.463),
                w_h: CAR_A_B,
                rot: 0.0, //????
            }, RotRect {
                pos: Vec2::new(789.336, 475.253),
                w_h: CAR_C,
                rot: std::f32::consts::FRAC_PI_2,
            }, RotRect {
                pos: Vec2::new(477.797, 111.38),
                w_h: CAR_C,
                rot: std::f32::consts::FRAC_PI_2,
            }, RotRect {
                pos: Vec2::new(512.045, 114.288),
                w_h: CAR_C,
                rot: std::f32::consts::FRAC_PI_2,
            }, RotRect {
                pos: Vec2::new(407.7, 113.812),
                w_h: CAR_A_B,
                rot: std::f32::consts::FRAC_PI_2,
            }, RotRect {
                pos: Vec2::new(445.075, 113.332),
                w_h: CAR_A_B,
                rot: std::f32::consts::FRAC_PI_2,
            }, RotRect {
                pos: Vec2::new(335.702, 112.81),
                w_h: CAR_C,
                rot: std::f32::consts::FRAC_PI_2,
            }, RotRect {
                pos: Vec2::new(369.95, 115.718),
                w_h: CAR_C,
                rot: std::f32::consts::FRAC_PI_2,
            }, RotRect {
                pos: Vec2::new(262.967, 115.152),
                w_h: CAR_A_B,
                rot: std::f32::consts::FRAC_PI_2,
            }, RotRect {
                pos: Vec2::new(300.342, 114.672),
                w_h: CAR_A_B,
                rot: std::f32::consts::FRAC_PI_2,
            }, RotRect {
                pos: Vec2::new(117.53, 116.191),
                w_h: CAR_A_B,
                rot: std::f32::consts::FRAC_PI_2,
            }, RotRect {
                pos: Vec2::new(154.905, 115.711),
                w_h: CAR_A_B,
                rot: std::f32::consts::FRAC_PI_2,
            }, RotRect {
                pos: Vec2::new(81.1483, 115.711),
                w_h: CAR_A_B,
                rot: std::f32::consts::FRAC_PI_2,
            }, RotRect {
                pos: Vec2::new(190.969, 114.15),
                w_h: CAR_C,
                rot: std::f32::consts::FRAC_PI_2,
            }, RotRect {
                pos: Vec2::new(225.217, 117.058),
                w_h: CAR_C,
                rot: std::f32::consts::FRAC_PI_2,
            }, RotRect {
                pos: Vec2::new(145.766, -36.875),
                w_h: CAR_C,
                rot: std::f32::consts::PI,
            }, Rect {
                pos: Vec2::new(439.405, -36.3901),
                w_h: CAR_C,
            }, Rect {
                pos: Vec2::new(515.24, 607.276),
                w_h: CAR_A_B,
            }, RotRect {
                pos: Vec2::new(660.551, 605.856),
                w_h: CAR_C,
                rot: std::f32::consts::PI,
            }, RotRect {
                pos: Vec2::new(589.153, 606.893),
                w_h: CAR_A_B,
                rot: std::f32::consts::PI,
            }, Rect {
                pos: Vec2::new(1027.25, 606.949),
                w_h: CAR_A_B,
            }, RotRect {
                pos: Vec2::new(1101.16, 606.566),
                w_h: CAR_A_B,
                rot: std::f32::consts::PI,
            }, RotRect {
                pos: Vec2::new(593.317, 284.532),
                w_h: CAR_A_B,
                rot: std::f32::consts::FRAC_PI_2,
            }, RotRect {
                pos: Vec2::new(592.287, 359.682),
                w_h: CAR_C,
                rot: std::f32::consts::FRAC_PI_2,
            }, RotRect {
                pos: Vec2::new(100.185, 171.345),
                w_h: CAR_C,
                rot: std::f32::consts::PI,
            }, RotRect {
                pos: Vec2::new(151.672, 193.085),
                w_h: CAR_C,
                rot: std::f32::consts::FRAC_PI_2,
            }, RotRect {
                pos: Vec2::new(150.642, 268.236),
                w_h: CAR_A_B,
                rot: std::f32::consts::FRAC_PI_2,
            }, RotRect {
                pos: Vec2::new(58.0687, 473.896),
                w_h: CAR_C,
                rot: std::f32::consts::FRAC_PI_2,
            }, RotRect {
                pos: Vec2::new(57.0387, 549.046),
                w_h: CAR_A_B,
                rot: std::f32::consts::FRAC_PI_2,
            }, Rect {
                pos: Vec2::new(437.556, 383.247),
                w_h: CAR_A_B,
            }, RotRect {
                pos: Vec2::new(541.318, 382.629),
                w_h: CAR_A_B,
                rot: std::f32::consts::PI,
            }, RotRect {
                pos: Vec2::new(364.473, 383.24),
                w_h: CAR_C,
                rot: std::f32::consts::PI,
            }, RotRect {
                pos: Vec2::new(290.708, 384.662),
                w_h: CAR_A_B,
                rot: std::f32::consts::PI,
            }, RotRect {
                pos: Vec2::new(520.703, 435.701),
                w_h: CAR_A_B,
                rot: std::f32::consts::FRAC_PI_2,
            }, RotRect {
                pos: Vec2::new(489.842, 406.583),
                w_h: CAR_C,
                rot: std::f32::consts::FRAC_PI_2,
            }, Rect {
                pos: Vec2::new(289.7, 456.787),
                w_h: CAR_A_B,
            }, Rect {
                pos: Vec2::new(736.149, 469.113),
                w_h: CAR_A_B,
            }, RotRect {
                pos: Vec2::new(289.821, 420.739),
                w_h: CAR_A_B,
                rot: std::f32::consts::PI,
            }, Rect {
                pos: Vec2::new(955.405, 605.856),
                w_h: CAR_C,
            }, Rect {
                pos: Vec2::new(809.884, 607.143),
                w_h: CAR_A_B,
            }, Rect {
                pos: Vec2::new(883.68, 607.056),
                w_h: CAR_A_B,
            }, RotRect {
                pos: Vec2::new(439.953, 606.347),
                w_h: CAR_C,
                rot: std::f32::consts::PI,
            }, Rect {
                pos: Vec2::new(733.756, 606.178),
                w_h: CAR_C,
            }, RotRect {
                pos: Vec2::new(733.459, -36.875),
                w_h: CAR_C,
                rot: std::f32::consts::PI,
            }, RotRect {
                pos: Vec2::new(811.183, -36.7325),
                w_h: CAR_C,
                rot: std::f32::consts::PI,
            }, RotRect {
                pos: Vec2::new(878.177, 36.8203),
                w_h: CAR_C,
                rot: std::f32::consts::PI,
            }, RotRect {
                pos: Vec2::new(877.542, 2.17767),
                w_h: CAR_C,
                rot: std::f32::consts::PI,
            }, RotRect {
                pos: Vec2::new(880.392, 106.592),
                w_h: CAR_C,
                rot: std::f32::consts::PI,
            }, RotRect {
                pos: Vec2::new(879.753, 72.2837),
                w_h: CAR_C,
                rot: std::f32::consts::PI,
            }, RotRect {
                pos: Vec2::new(882.292, 177.298),
                w_h: CAR_C,
                rot: std::f32::consts::PI,
            }, RotRect {
                pos: Vec2::new(881.899, 141.559),
                w_h: CAR_C,
                rot: std::f32::consts::PI,
            }, RotRect {
                pos: Vec2::new(148.358, 606.136),
                w_h: CAR_C,
                rot: std::f32::consts::PI,
            }, Rect {
                pos: Vec2::new(75.5358, 606.882),
                w_h: CAR_A_B,
            }, Rect {
                pos: Vec2::new(-0.755966, 605.879),
                w_h: CAR_C,
            }
        ];
